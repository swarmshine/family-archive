...
object Libs {
    ...
    const val http_client = "org.apache.httpcomponents:httpclient:4.5.12"
    ...
    const val selenium_java = "org.seleniumhq.selenium:selenium-java:${Vers.selenium}"
    const val selenium_chrome_driver = "org.seleniumhq.selenium:selenium-chrome-driver:${Vers.selenium}"
    const val webdrivermanager = "io.github.bonigarcia:webdrivermanager:4.2.0"
}
